...
public class RadarUtils {
    ...
    /**
     * Initialise Avro Decoder
     * @throws NullPointerException no input
     * @return {key schema, value schema} it might contain null values if no schema has been used
     */
    public static KafkaAvroDecoder getAvroDecoder(){
        VerifiableProperties vProps = new VerifiableProperties(KafkaProperties.getAvroDecoder());
        return new KafkaAvroDecoder(vProps);
    }
}

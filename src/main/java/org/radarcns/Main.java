            ...
            public void run() {
                ...
                while(!shutdown.get()) {
                    ...
                    for (; offset < sequence; offset++) {
                        ...
                        EmpaticaE4InterBeatInterval value = new EmpaticaE4InterBeatInterval(date.getTime(),date.getTime(),r.nextFloat());

                        collector.add(RadarUtils.floatToDouble(value.getInterBeatInterval()));

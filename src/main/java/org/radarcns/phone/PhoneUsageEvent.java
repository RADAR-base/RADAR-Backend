...
public class PhoneUsageEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public UsageEventType eventType;
   ...
   */
  public PhoneUsageEvent(java.lang.Double time, java.lang.Double timeReceived, java.lang.CharSequence packageName, java.lang.CharSequence categoryName, java.lang.Double categoryNameFetchTime, UsageEventType eventType) {
    this.time = time;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: eventType = (UsageEventType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setEventType(UsageEventType value) {
   ...
   */
  public static PhoneUsageEvent.Builder newBuilder() {
    return new PhoneUsageEvent.Builder();
  }
   ...
   * @return A new PhoneUsageEvent RecordBuilder
   */
  public static PhoneUsageEvent.Builder newBuilder(PhoneUsageEvent.Builder other) {
    return new PhoneUsageEvent.Builder(other);
  }
   ...
   * @return A new PhoneUsageEvent RecordBuilder
   */
  public static PhoneUsageEvent.Builder newBuilder(PhoneUsageEvent other) {
    return new PhoneUsageEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneUsageEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PhoneUsageEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PhoneUsageEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setTime(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setTimeReceived(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearTimeReceived() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setPackageName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearPackageName() {
      packageName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setCategoryName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearCategoryName() {
      categoryName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setCategoryNameFetchTime(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearCategoryNameFetchTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder setEventType(UsageEventType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PhoneUsageEvent.Builder clearEventType() {
      eventType = null;
    ...
    public PhoneUsageEvent build() {
      try {
        ...
        record.eventType = fieldSetFlags()[5] ? this.eventType : (UsageEventType) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {

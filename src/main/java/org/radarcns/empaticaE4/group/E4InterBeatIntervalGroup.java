 ...
 */
public class E4InterBeatIntervalGroup extends GroupAggregator {

    public E4InterBeatIntervalGroup(int numThreads, String clientID) throws InvalidParameterException,IOException {
        super(numThreads,clientID);
    }

    @Override
    public AggregatorRadar createAggregator() throws IOException{
        return new E4InterBeatInterval(getPoolName());
    }

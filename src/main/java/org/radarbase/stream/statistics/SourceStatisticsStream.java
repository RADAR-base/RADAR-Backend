...
import static org.radarbase.monitor.AbstractKafkaMonitor.extractKey;
        ...
        private void updatePunctuate() {
            if (!localInterval.equals(getInterval())) {
                ...
                punctuateCancellor = this.context.schedule(
                        Duration.ofMillis(localInterval.toMillis()), PunctuationType.WALL_CLOCK_TIME, this::sendNew);
            }
        }

...
import static org.radarbase.stream.AbstractStreamWorker.TIME_WINDOW_COMMIT_INTERVAL_DEFAULT;
import static org.radarbase.util.Comparison.compare;
...
public class StreamDefinition implements Comparable<StreamDefinition> {
    ...
    public StreamDefinition(@Nonnull KafkaTopic input, @Nullable KafkaTopic output,
        ...
        this(input, output, window == null ? null : TimeWindows.ofSizeWithNoGrace(Duration.ofMillis(window.toMillis())),
